...
class mcl:
    ...
    def getMap(self):
        ...
        self.mapCenterX = int(map_msg.info.origin.position.x + map_msg.info.width * map_msg.info.resolution / 2.0)
...
class MclNode(object):
    def __init__(self):
        ...
        self.subscribe_laser = rospy.Subscriber('/laser/scan', LaserScan, self.callback_laser, queue_size=10)
